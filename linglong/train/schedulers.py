...
def cosine_annealing_warmup(
    ...
    warmup_steps = int(config['mcpt']['warmup_tokens'] / config['train_micro_batch_size_per_gpu'] / dp_size / n_ctx)
    decay_steps = int(config['mcpt']['decay_tokens'] / config['train_micro_batch_size_per_gpu'] / dp_size / n_ctx)
