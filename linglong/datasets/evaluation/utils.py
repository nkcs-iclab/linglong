...
def load(config: Dict[str, Any]):
    ...
    datasets = {
        'generation': {
            'CEPSUM2-cases-bags': mcpt.datasets.evaluation.generation.CEPSUM2DatasetBase,
            'CEPSUM2-clothing': mcpt.datasets.evaluation.generation.CEPSUM2DatasetBase,
            'CEPSUM2-home-appliances': mcpt.datasets.evaluation.generation.CEPSUM2DatasetBase,
            'LCSTS': mcpt.datasets.evaluation.generation.LCSTSDatasetBase,
            'AdGen': mcpt.datasets.evaluation.generation.AdGenDatasetBase,
            'KBQA': mcpt.datasets.evaluation.generation.KBQADatasetBase,
            ...
            'LCQMC': mcpt.datasets.evaluation.generation.LCQMCDatasetBase,
            'Math23K': mcpt.datasets.evaluation.generation.Math23KDatasetBase,
